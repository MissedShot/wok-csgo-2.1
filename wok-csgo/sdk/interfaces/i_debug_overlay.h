...
public:
	...
	VFUNC(add_line_overlay(const vec3_t& from, const vec3_t& to, const col_t& clr, bool no_depth_test, float duration), 5,
		void(__thiscall*)(void*, const vec3_t&, const vec3_t&, int, int, int, bool, float), from, to, clr.r(), clr.g(), clr.b(), no_depth_test, duration)
